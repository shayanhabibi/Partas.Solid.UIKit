import{j as e}from"./iframe-mHl6JQ-c.js";import{useMDXComponents as t}from"./index-B7Otj1x9.js";import"./preload-helper-PPVm8Dsz.js";function s(r){const n={blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"utils",children:"Utils"}),`
...
`,e.jsx(n.p,{children:"The array of chart colors. See the 'ColorPalette'."})]})}function o(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(s,{...r})}):s(r)}export{o as default};
