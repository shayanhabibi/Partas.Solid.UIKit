import{T as s,a as l,b as n,c as t,d as c,e as u}from"./Tabs-C-h7f3JJ.js";import{c as r,m as i}from"./iframe-mHl6JQ-c.js";const{fn:d}=__STORYBOOK_MODULE_TEST__,b={args:{onChange:d()},argTypes:{value:{control:{type:"text"},table:{type:{summary:"string"}}},defaultValue:{control:{type:"text"},table:{type:{summary:"string"}}},onChange:{control:{type:!1},table:{type:{summary:"function"}}},orientation:{control:{type:"radio"},options:["vertical","horizontal"],table:{type:{summary:"[<StringEnum>]"}}},activationMode:{control:{type:"radio"},options:["manual","automatic"],table:{type:{summary:"[<StringEnum>]"}}},disabled:{control:{type:"boolean"},table:{type:{summary:"bool"}}}},render:o=>r(s,i(o,{"bool:n$":!1,get children(){return[r(l,{class:"grid w-full grid-cols-2",get children(){return[r(n,{value:"account",children:"Account"}),r(n,{value:"password",children:"Password"})]}}),r(t,{value:"account",children:"Account Tab"}),r(t,{value:"password",children:"Password tab"})]}})),component:s},a={args:{}},e={render:o=>r(s,i(o,{"bool:n$":!1,get children(){return[r(l,{class:"grid w-full grid-cols-2",get children(){return[r(c,{value:"account",children:"Account"}),r(c,{value:"password",children:"Password"}),r(u,{class:"bg-primary"})]}}),r(t,{value:"account",children:"Account Tab"}),r(t,{value:"password",children:"Password tab"})]}}))};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {}
