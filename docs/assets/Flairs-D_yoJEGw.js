import{G as e,H as f,T as m,K as a,L as o}from"./iframe-Ss2HFUgg.js";import{useMDXComponents as d}from"./index--e61kTGT.js";import{S as u,D as s}from"./Particles.stories-Bw8wyQxC.js";import{Default as i}from"./BorderBeam.stories-Db5tVt3h.js";import{Default as l}from"./AuroraBanner.stories-Ca8lSEoJ.js";import{Default as c}from"./Logo.stories-Biblm4XV.js";import"./preload-helper-PPVm8Dsz.js";import"./Util-jMr-gVD5.js";import"./Array-DTFxpKaG.js";import"./Option-B9lMbA8r.js";import"./Utils-Bv7TLaDt.js";import"./index-axew2xP3.js";import"./common-DvkHkTuv.js";import"./List-DitsdVDI.js";import"./String-DLdTzCOk.js";import"./stagger-BpUZ1ZuV.js";import"./index-DiMPxCbG.js";const y=`\uFEFFnamespace Partas.Solid.UI\r
\r
open Browser\r
...
type Particles() =\r
    ...
    member props.__ =\r
        ...
        let mutable circles: CircleSpinner[] = [||]\r
        ...
        let circleParams (): CircleSpinner =\r
            ...
            CircleSpinner(x,y,translateX,translateY,pSize,alpha,targetAlpha,dx,dy,magnetism)\r
            \r
        let drawCircle (update: bool) (circle: CircleSpinner) =\r
            if !!context then\r
                context\r
                ...
                if not update then\r
                    circles |> unbox<ResizeArray<CircleSpinner>> |> _.Add(circle)\r
        let resizeCanvas() =\r
        ...
        let rec animate () =\r
            ...
            |> Array.iteri(fun i circle ->\r
                ...
                then\r
                    circles |> unbox<ResizeArray<CircleSpinner>> |> _.RemoveAt(i)\r
                    circleParams()\r
                    |> drawCircle false\r
                )\r
        let drawParticles() =\r
...
`,e.jsx(a,{of:c}),`
`,e.jsx(o,{of:c}),`
`,e.jsx(t,{code:g})]})}function L(r={}){const{wrapper:n}={...d(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(p,{...r})}):p(r)}function b(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}export{L as default};
