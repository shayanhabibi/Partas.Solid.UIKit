import{G as n}from"./iframe-BLvaHOrW.js";import{useMDXComponents as s}from"./index-DMt2PYli.js";import"./preload-helper-PPVm8Dsz.js";const a=`\uFEFF[<AutoOpen>]\r
...
type Singletons =\r
        static member useIsMobile (fallback: bool) =\r
            createSingletonRoot(fun _ ->\r
                let (isMobile, setIsMobile) = createSignal(fallback)\r
                createEffect(\r
                        fun () ->\r
                            let mobileBreakpointListener =\r
                                    makeMediaQueryListener\r
                                        $"(max-width:{mobileBreakpoint - 1}px"\r
                                        (fun event -> setIsMobile(event.matches))\r
                            onCleanup(mobileBreakpointListener)\r
                    )\r
                isMobile\r
            )\r
`;function i(r){const e={blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...r.components},{SourceCode:t}=e;return t||o("SourceCode"),n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"utils",children:"Utils"}),`
`,n.jsx(t,{code:a}),`
...
`,n.jsx(e.p,{children:"The array of chart colors. See the 'ColorPalette'."})]})}function p(r={}){const{wrapper:e}={...s(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(i,{...r})}):i(r)}function o(r,e){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
