import{T as r,a as y,b as p,c as g}from"./Text-CFcP1xt3.js";import{c as e,m as b,a as u}from"./iframe-Ss2HFUgg.js";const{fn:d}=__STORYBOOK_MODULE_TEST__,_={args:{onChange:d(),onBlur:d()},argTypes:{value:{control:{type:"text"},table:{type:{summary:"string"}}},defaultValue:{control:{type:"text"},table:{type:{summary:"string"}}},onChange:{control:{type:!1},table:{type:{summary:"function"}}},onBlur:{control:{type:!1},table:{type:{summary:"function"}}},name:{control:{type:"text"},table:{type:{summary:"string"}}},validationState:{control:{type:"text"},table:{type:{summary:"string"}}},required:{control:{type:"boolean"},table:{type:{summary:"bool"}}},disabled:{control:{type:"boolean"},table:{type:{summary:"bool"}}},readOnly:{control:{type:"boolean"},table:{type:{summary:"bool"}}}},render:n=>e(r,b(n,{"bool:n$":!1,get children(){return e(p,{})}})),component:r},t={args:{}},a={render:n=>{const o=u(void 0),l=o[1],s=u(""),i=s[0];return e(r,{get validationState(){return o[0]()},get value(){return i()},onChange:c=>{(m=>{s[1](m),i()==="valid"?l("valid"):l("invalid")})(c)},get children(){return[e(y,{children:"Input"}),e(p,{placeholder:"Enter 'valid'"}),e(g,{children:"Input should be 'valid'"})]}})}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {}
