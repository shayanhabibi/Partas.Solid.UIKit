import{A as r,a as l,b as i,c as a,d as s}from"./AlertDialog-BasWqlMU.js";import{B as p}from"./Button-Can5pglF.js";import{c as e,m as d}from"./iframe-CYoISbNW.js";const{fn:g}=__STORYBOOK_MODULE_TEST__,m={args:{onOpenChange:g()},argTypes:{defaultOpen:{control:{type:"boolean"},description:"The default open state when initially rendered. Useful when you do not need to control the open state.",table:{type:{summary:"bool"}}},forceMount:{control:{type:"boolean"},description:`Used to force mounting the dialog (portal, overlay and content) when more control is needed. Useful when
