import{A as t}from"./AvatarStack-Cgvurlh2.js";import{c as n,m as i}from"./iframe-BHVPMPJn.js";const m={args:{},argTypes:{animate:{control:{type:"boolean"},description:"Whether to animate the avatars on hover.",table:{defaultValue:{summary:"false"},type:{summary:"bool"}}},items:{control:{type:"object"},description:`The array of items which are able to interface with IAvatarStackItem,
