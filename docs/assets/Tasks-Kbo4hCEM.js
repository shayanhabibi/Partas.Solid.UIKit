import{H as e}from"./iframe-DHSEN8D7.js";import{useMDXComponents as a}from"./index-e4aCb-2o.js";import{K as l}from"./Empty-D2SBt1nw.js";import{L as s}from"./Field-BfJPVqnm.js";import{M as i}from"./InputGroup-D0dsBI9_.js";import{N as p}from"./Item-oNgh1nsy.js";import"./preload-helper-PPVm8Dsz.js";const d=`\uFEFFnamespace Partas.Solid.UI\r
open Partas.Solid\r
...
type CommandPicker<'Data when 'Data: equality and 'Data: not struct and 'Data: not null>() =\r
    ...
    member props.__ =\r
        ...
        let inline popoverTriggerRender () =\r
            Fragment() {\r
                Lucide.CirclePlus(class' = Lib.cn [|\r
                ...
                div(\r
                    ...
                    Button(disabled = props.loading, onClick = fun _ -> onSave()\r
                        ...
                        if props.loading then\r
                            Lucide.LoaderCircle(class' = "animate-spin")\r
                        else "Save"\r
                    }\r
                }\r
            }\r
...
`,m=`\uFEFFmodule Partas.Solid.UI.Kit.Tables.DataTable\r
\r
\r
open Partas.Solid\r
open Partas.Solid.UI\r
                ...
                div( class' = Lib.cn [| "flex items-center space-x-2"; props.class' |] ) {\r
                    DropdownMenu() {\r
                        DropdownMenuTrigger()\r
                            ...
                            Show(\r
                                when' = canSort()\r
                                ,fallback = (Lucide.EllipsisVertical(size = 4))\r
                                ) {\r
                        ...
                        DropdownMenuContent() {\r
                            ...
                            Show(when' = canHide()) {\r
                                DropdownMenuItem(onClick = fun _ -> props.column.toggleVisibility(false)) {\r
                                    Lucide.EyeOff(class' = iconClass)\r
                                    "Hide"\r
                                }\r
                            }\r
                            \r
...
type TableViewOptions<'Data>() =\r
    ...
    member props.__ =\r
      ...
      \r
`;function o(t){const n={h1:"h1",h2:"h2",h3:"h3",p:"p",...a(),...t.components},{SourceCode:r}=n;return r||C("SourceCode"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"tasks",children:"Tasks"}),`
...
`,e.jsx(r,{code:l}),`
`,e.jsx(n.h3,{id:"field",children:"Field"}),`
`,e.jsx(r,{code:s}),`
`,e.jsx(n.h3,{id:"inputgroup",children:"InputGroup"}),`
`,e.jsx(r,{code:i}),`
...
`,e.jsx(r,{code:v})]})}function D(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}function C(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{D as default};
