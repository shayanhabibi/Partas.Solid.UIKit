import{c as e,a as h,m as s}from"./iframe-CSkHCzVC.js";import{A as l,a as c,b as d,c as g,d as m,e as p,f as u,g as A,h as b,i as f}from"./AlertDialog-CqphsOhy.js";import{B as D}from"./Button-CukqsTBC.js";const{fn:y}=__STORYBOOK_MODULE_TEST__,_={args:{onOpenChange:y()},argTypes:{defaultOpen:{control:{type:"boolean"},description:"The default open state when initially rendered. Useful when you do not need to control the open state.",table:{type:{summary:"bool"}}},forceMount:{control:{type:"boolean"},description:`Used to force mounting the dialog (portal, overlay and content) when more control is needed. Useful when
