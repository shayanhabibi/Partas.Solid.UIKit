import{c as e,a as h,m as s}from"./iframe-Ss2HFUgg.js";import{A as l,a as c,b as d,c as g,d as p,e as u,f as m,g as A,h as b,i as f}from"./AlertDialog-DdqOLQQn.js";import{B as D}from"./Button-CkUVEkt2.js";const{fn:y}=__STORYBOOK_MODULE_TEST__,_={args:{onOpenChange:y()},argTypes:{defaultOpen:{control:{type:"boolean"},description:"The default open state when initially rendered. Useful when you do not need to control the open state.",table:{type:{summary:"bool"}}},forceMount:{control:{type:"boolean"},description:`Used to force mounting the dialog (portal, overlay and content) when more control is needed. Useful when
