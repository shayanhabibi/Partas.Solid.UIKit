...
type Dynamic() =
    ...
    [<DefaultValue>] val mutable component': HtmlTag
...
type BarList() =
    inherit div()
    [<DefaultValue>] val mutable data: Bar[]
    [<DefaultValue>] val mutable valueFormatter: ValueFormatter
    [<DefaultValue>] val mutable sortOrder: SortOrder
